...
export ZSH="/home/tjang/.oh-my-zsh"
...
alias grep='grep --color=auto --exclude-dir={.bzr,.cvs,.git,.hg,.svn} --exclude={cscope.out}'

# Get rid of the annoying single-history behavior
...
# oh-my-zsh provides their own alias... override it!


# keybindings (do this after oh-by-zsh.sh)
